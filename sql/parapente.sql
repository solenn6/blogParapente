...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 07 mai 2020 à 13:45
...
CREATE TABLE IF NOT EXISTS `site` (
  ...
  `site_filtre_altitude` varchar(255) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id_site`)
